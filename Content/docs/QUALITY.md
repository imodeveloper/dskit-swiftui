...
4. Keep generated docs and assets (`Content/Views.md`, `Content/Views/*.md`, `Content/Views/UsageIndex.md`, `Content/Screens.md`, `Content/Screens/*.md`, and `Content/Screens/Frames/*.framed.svg`) regenerated from source and snapshots, not manually rewritten.
