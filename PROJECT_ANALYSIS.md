...
## 3) Relationship to imodeveloper

- The workspace in `imodeveloper/Workspace.xcworkspace` references `DSKitExplorer.xcodeproj`.
...
- `README.md` describes DSKit usage and SPM integration, but omits:
  ...
  - How the workspace in `imodeveloper` consumes DSKit.
