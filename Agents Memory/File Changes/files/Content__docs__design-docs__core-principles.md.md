# Content/docs/design-docs/core-principles.md

- source_path: `Content/docs/design-docs/core-principles.md`
...
#### Change Summary
Moved the design core principles guide from `docs/design-docs/core-principles.md` to `Content/docs/design-docs/core-principles.md`.

#### Rationale
Design-principle documentation should live under the unified `Content/` documentation tree.

#### Invariants
Keep this page high-level. Detailed workflow and generator rules belong in `Content/docs/WORKFLOWS.md`, `Content/Documentation.md`, and `AGENTS.md`.

#### Tests Or Evidence
Validated local Markdown links, ran staged whitespace validation, and ran the file-change memory check.

#### Related Files
`Content/docs/design-docs/ds-wrapper-principles.md`, `Content/Views.md`, `Content/Screens.md`.
