...
- `agent_memory_audit.sh`: validates compact memory, agent-facing routes,
  retired journal instructions, personal paths, active-plan freshness, and
  credential-like files after memory or routing changes.
